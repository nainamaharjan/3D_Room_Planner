...
class DateConversionServices: UIViewController {
    ...
    public func engToNep(yy:Int, mm:Int, dd:Int) -> [String:Any] {
...
//        }
        ...
        let convertedDateObject = [
            "nepaliYear" : convertedYear,
            "nepaliMonth" : convertedMonth,
            "nepaliDate" : convertedDate
        ]
    ...
    public func nepToEng(yy:Int,mm:Int,dd:Int) -> [String:Any] {
...
//            convertedNubDay = day;
        ...
        let convertedDateObject = [
            "englishYear" : convertedYear,
            "englishMonth" : convertedMonth,
            "englishDate" : convertedDate
        ]
    ...
    public func getDaysCount(year : Int, month: Int) -> Int {
        
        if year < 2000 || year > 2090 || month < 1 || month > 12 {
            print("Date conversion: Invalid data supplied", year, month)
            return 32
        }
